...
-- setup autotile data
local autotile = rained.tiles.createAutotile("SH grate box", "Pattern Boxes")
autotile.type = "rect"
...
function autotile:tileRect(layer, left, top, right, bottom, forceModifier)
    helpers.patternBox("SUGrate", layer, left, top, right, bottom, forceModifier, autotile:getOption("border"))
end